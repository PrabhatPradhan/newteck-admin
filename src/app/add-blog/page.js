            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input name="title" onChange={handleChange} className={inputStyle} />
                </div>
                <div className="md:col-span-2">
                  <label className="block mb-1 font-medium">Short Description</label>
                  <textarea name="shortDescription" onChange={handleChange} className={inputStyle} />
                </div>
                <div className="md:col-span-2">
                ...
                <div>
                  ...
                  <input name="imageAlt" onChange={handleChange} className={inputStyle} />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <input name="metaKeywords" placeholder="Meta Key" onChange={handleChange} className={inputStyle} />
